...
export default function PublicLanding({ onOpenLogin }) {
  ...
  async function handleSubmit(event) {
    ...
    if (!sheetsWebhookUrl) {
      setError("Configure VITE_GOOGLE_SHEETS_WEBHOOK_URL para enviar os leads diretamente ao Google Sheets.");
      return;
    }
    ...
    try {
      ...
      setError("Nao foi possivel enviar seus dados para a planilha agora. Verifique a publicacao do webhook do Google Sheets.");
    } finally {
      setSubmitting(false);
    }
  }
